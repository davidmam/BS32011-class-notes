...
sequencefile='../ImogenS/m_nivalis.fasta'
...
p3i=open('primer3input_m_nivalis.txt','w') #opens output file and prepares to write to it 

for k in primer3params.keys():
    p3i.write('%s=%s'%(k,primer3params[k] + '\n'))  # outputs primer parameters in dictionary along with the full sequence for m_nivalis in a format primer3 can read
